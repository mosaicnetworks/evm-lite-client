...
var Keystore = /** @class */ (function () {
    ...
    Keystore.create = function (output, password) {
        var account = Library_1.Account.create();
    ...
    Keystore.prototype.files = function () {
        var json = [];
    ...
    Keystore.prototype.all = function (fetch, connection) {
        ...
        return new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
            var accounts, files, _i, files_2, file, address, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        _b = (_a = accounts).push;
                        return [4 /*yield*/, connection.api.getAccount(address)];
                    case 2:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 4];
                    case 3:
    ...
    Keystore.prototype.get = function (address) {
        ...
        return this.files().filter(function (file) { return file.address === address; })[0] || null;
    };
    Keystore.prototype.find = function (address) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, connection.api.getAccount(address)];
                                case 1:
                                    account = _a.sent();
                                    if (account) {
                                        resolve(account);
