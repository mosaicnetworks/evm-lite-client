...
var TransactionsGet_1 = require("../../src/commands/TransactionsGet");
var stage_1 = require("../stage");
var Staging_1 = require("../../src/classes/Staging");
var assert = Chai.assert;
describe('Command: transactions get', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, TransactionsGet_1.stage(args, stage_1.session)];
                case 1:
                    result = _a.sent();
    ...
    it('should return error no hash was provided', function () { return __awaiter(_this, void 0, void 0, function () {
        var args, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
